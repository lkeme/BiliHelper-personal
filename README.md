...
![](https://img.shields.io/github/last-commit/lkeme/BiliHelper-personal/master?style=flat-square "GitHub last commit")
![](https://img.shields.io/github/commit-activity/w/lkeme/BiliHelper-personal/master?style=flat-square "GitHub commit activity")
![](https://img.shields.io/github/commit-activity/m/lkeme/BiliHelper-personal/master?style=flat-square "GitHub commit activity")
![](https://img.shields.io/github/languages/count/lkeme/BiliHelper-personal "languages count")
...
* [配置文档 / CONFIG.ini](https://github.com/lkeme/BiliHelper-personal/blob/master/profile/example/config/user.ini)
...
| DynamicLottery     | 0.0.2   | 动态抽奖(互动抽奖) | MoeHero/Lkeme     | 2010 | 10-25(分钟) | √      |
