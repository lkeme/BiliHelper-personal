...
class ApiIndex
{
     ...
     * @return array
     */
    public static function roomEntryAction(int $room_id): array
    {
        ...
        return ApiJson::post('pc', $url . '?' . http_build_query($query), $payload, $headers, 'xlive.web_room.room_entry_action');
    }
}
