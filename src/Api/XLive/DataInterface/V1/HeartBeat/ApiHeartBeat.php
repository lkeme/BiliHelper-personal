...
class ApiHeartBeat extends AbstractApiClient
{
    ...
    public function mobileHeartBeat(int $roomId, int $upId, int $parentId, int $areaId, string $heartbeatUrl): array
    {
        ...
        return $this->decodePost('app', 'https://live-trace.bilibili.com/xlive/data-interface/v1/heartbeat/mobileHeartBeat', $this->request()->signCommonPayload($payload), [
            'Content-Type' => 'application/x-www-form-urlencoded',
        ], 'xlive.heartbeat.mobile');
    }
